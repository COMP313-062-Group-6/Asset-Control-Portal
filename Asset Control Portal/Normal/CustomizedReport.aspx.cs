...
public partial class Normal_CustomizedReport : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        GridView1.DataSource = obj.Customised(TextBox1.Text, Convert.ToInt32(Session["EMPID"]));
        GridView1.DataBind();
    ...
    protected void LinkButton3_Click(object sender, EventArgs e)
    {
        ...
        BLLReports obj = new BLLReports();
        System.Data.DataTable tb = obj.Customised(TextBox1.Text, Convert.ToInt32(Session["EMPID"]));
        ...
        FN = FN + "\\CustomizedReportFile.XLS";
        ...
        Response.AppendHeader("Content-Disposition", "Attachment;FileName=CustomizedReportFile.XLS");
